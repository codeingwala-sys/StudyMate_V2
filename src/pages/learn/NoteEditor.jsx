...
export default function NoteEditor() {
  ...
  const commitDrawing = useCallback(() => {
    ...
    const finalW = (maxX - minX) / dpr
    const finalH = (maxY - minY) / dpr
    off.width = maxX - minX
    ...
    if (dpr > 1) {
      ...
      downscaled.width = finalW
      downscaled.height = finalH
      const dsCtx = downscaled.getContext('2d')
      dsCtx.drawImage(off, 0, 0, finalW, finalH)
      finalDataUrl = downscaled.toDataURL('image/png')
    } else {
