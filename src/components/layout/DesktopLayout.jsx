...
function DesktopHome({ t, isDark }) {
  ...
  const QUICK = [
    ...
    { label: 'Socratic Viva', sub: 'Adaptive Exam', path: '/learn/socratic', color: t.red, emoji: '🤔' },
    { label: 'Flashcards', sub: 'AI cards', path: '/learn/flashcards', color: t.amber, emoji: '🃏' },
    { label: 'Whiteboard', sub: 'Mind-Sync', path: '/learn/whiteboard', color: t.blue, emoji: '🎨' },
...
function DesktopLearn({ t, isDark }) {
  ...
  const TOOLS = [
    ...
    { emoji: '🤔', label: 'Socratic Viva', sub: 'Adaptive Exam', path: '/learn/socratic', color: t.red },
    { emoji: '🎨', label: 'Whiteboard', sub: 'Collab Mind-Sync', path: '/learn/whiteboard', color: t.blue },
  ...
  return (
    <div style={{ padding: '36px 44px', overflowY: 'auto', height: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 18, marginBottom: 28 }}>
        <Card onClick={() => nav('/practice/mode1')} t={t} style={{ padding: '24px', background: isDark ? 'linear-gradient(135deg,rgba(167,139,250,0.12),rgba(139,92,246,0.06))' : 'linear-gradient(135deg,rgba(124,58,237,0.06),rgba(109,40,217,0.03))', border: `1px solid ${t.purple}30`, borderRadius: 20 }}>
          <div style={{ width: 44, height: 44, borderRadius: 12, background: t.purpleBg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, marginBottom: 14 }}>◈</div>
          <p style={{ fontSize: 17, fontWeight: 800, color: t.text, fontFamily: 'Inter,sans-serif', margin: '0 0 6px' }}>Practice from Notes</p>
          <p style={{ fontSize: 12, color: t.textMuted, fontFamily: 'Inter,sans-serif', margin: '0 0 14px', lineHeight: 1.5 }}>AI-generated MCQs and tests from your uploaded notes.</p>
          <div style={{ display: 'flex', gap: 5 }}>
            {['MCQs', 'Fill-in'].map(n => <span key={n} style={{ fontSize: 10, color: t.purple, background: t.purpleBg, padding: '2px 8px', borderRadius: 20, fontWeight: 600 }}>{n}</span>)}
          </div>
        </Card>
        <Card onClick={() => nav('/practice/battle')} t={t} style={{ padding: '24px', background: isDark ? 'linear-gradient(135deg,rgba(249,115,22,0.1),rgba(234,88,12,0.05))' : 'linear-gradient(135deg,rgba(251,146,60,0.06),rgba(249,115,22,0.03))', border: `1px solid ${t.amber}30`, borderRadius: 20 }}>
          <div style={{ width: 44, height: 44, borderRadius: 12, background: t.amberBg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, marginBottom: 14 }}>⚔️</div>
          <p style={{ fontSize: 17, fontWeight: 800, color: t.text, fontFamily: 'Inter,sans-serif', margin: '0 0 6px' }}>Recall Battles</p>
          <p style={{ fontSize: 12, color: t.textMuted, fontFamily: 'Inter,sans-serif', margin: '0 0 14px', lineHeight: 1.5 }}>Multiplayer real-time quiz battles. Rank up and win.</p>
          <span style={{ fontSize: 10, color: t.amber, background: t.amberBg, padding: '2px 8px', borderRadius: 20, fontWeight: 600 }}>Live Multiplayer</span>
        </Card>
        <Card onClick={() => nav('/practice/study-buddies')} t={t} style={{ padding: '24px', background: isDark ? 'linear-gradient(135deg,rgba(167,139,250,0.1),rgba(139,92,246,0.05))' : 'linear-gradient(135deg,rgba(167,139,250,0.06),rgba(139,92,246,0.03))', border: `1px solid ${t.purple}20`, borderRadius: 20 }}>
          <div style={{ width: 44, height: 44, borderRadius: 12, background: t.purpleBg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, marginBottom: 14 }}>🤝</div>
          <p style={{ fontSize: 17, fontWeight: 800, color: t.text, fontFamily: 'Inter,sans-serif', margin: '0 0 6px' }}>Study Buddies</p>
          <p style={{ fontSize: 12, color: t.textMuted, fontFamily: 'Inter,sans-serif', margin: '0 0 14px', lineHeight: 1.5 }}>Study alongside friends with synced focus timers and shared accountability.</p>
          <span style={{ fontSize: 10, color: t.purple, background: t.purpleBg, padding: '2px 8px', borderRadius: 20, fontWeight: 600 }}>Focus Friends</span>
        </Card>
        <Card onClick={() => nav('/practice/syllabus')} t={t} style={{ padding: '24px', background: isDark ? 'linear-gradient(135deg,rgba(251,191,36,0.1),rgba(217,119,6,0.05))' : 'linear-gradient(135deg,rgba(251,191,36,0.06),rgba(217,119,6,0.03))', border: `1px solid ${t.amber}20`, borderRadius: 20 }}>
          <div style={{ width: 44, height: 44, borderRadius: 12, background: t.amberBg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, marginBottom: 14 }}>📜</div>
          <p style={{ fontSize: 17, fontWeight: 800, color: t.text, fontFamily: 'Inter,sans-serif', margin: '0 0 6px' }}>Syllabus Map</p>
          <p style={{ fontSize: 12, color: t.textMuted, fontFamily: 'Inter,sans-serif', margin: '0 0 14px', lineHeight: 1.5 }}>Generate a roadmap from your university syllabus.</p>
          <span style={{ fontSize: 10, color: t.amber, background: t.amberBg, padding: '2px 8px', borderRadius: 20, fontWeight: 600 }}>Roadmap AI</span>
        </Card>
        <Card onClick={() => nav('/practice/mode2')} t={t} style={{ padding: '24px', background: isDark ? 'linear-gradient(135deg,rgba(74,222,128,0.08),rgba(34,197,94,0.04))' : 'linear-gradient(135deg,rgba(22,163,74,0.06),rgba(16,122,56,0.03))', border: `1px solid ${t.green}25`, borderRadius: 20 }}>
          <div style={{ width: 44, height: 44, borderRadius: 12, background: t.greenBg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, marginBottom: 14 }}>◎</div>
          <p style={{ fontSize: 17, fontWeight: 800, color: t.text, fontFamily: 'Inter,sans-serif', margin: '0 0 6px' }}>Custom Topic Quiz</p>
          <p style={{ fontSize: 12, color: t.textMuted, fontFamily: 'Inter,sans-serif', margin: '0 0 14px', lineHeight: 1.5 }}>Enter any topic and AI generates a full quiz instantly.</p>
          <span style={{ fontSize: 10, color: t.green, background: t.greenBg, padding: '2px 8px', borderRadius: 20, fontWeight: 600 }}>Adaptive Difficulty</span>
        </Card>
      </div>
